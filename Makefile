...
build/package/http/efi32/syslinux.0: build/cache/syslinux
	...
	find build/cache/syslinux/efi32/com32 -name '*.c32' | xargs cp -t build/package/http/efi32
...
build/package/http/efi64/syslinux.0: build/cache/syslinux
	...
	find build/cache/syslinux/efi64/com32 -name '*.c32' | xargs cp -t build/package/http/efi64
